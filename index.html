        ...
        <main>
            ...
            <section id="portfolio">
                ...
                <div class="proj">
                    ...
                    <p>Création d'un site Web afin de me présenter et présenter les projets que j'ai pu mener 
                        <br> <span><a href="https://github.com/EvanSaleck/Portfolio">Cliquez ici pour voir le code</a></span>
                    </p>
                </div>
            ...
            <section id="contact">
               ...
               <!-- Début du PHP -- <?php
                    ...
                    $to = 'evan.saleck@gmail.com';

                    // Charge la bibliothèque client Gmail de Google
                    require_once __DIR__ . '/vendor/autoload.php';

                    // Crée un nouveau client Gmail
                    ...
                    // Crée un nouveau service Gmail
                    $service = new Google_Service_Gmail($client);

                    // Crée un nouveau message
                    $strSubject = "Nouveau message de formulaire de contact";
                    $strRawMessage = "From: {$name} <{$email}>\r\n";
                    $strRawMessage .= "To: {$to}\r\n";
                    ...
                    try {
                        ...
                        $msg->setRaw($mime);
                        $send_message = $service->users_messages->send("me", $msg);
                        echo "Votre message a bien été envoyé.";
                    } catch (Exception $e) {
                        echo "Une erreur est survenue lors de l'envoi de votre message : " . $e->getMessage();
                    }
                    ?>
